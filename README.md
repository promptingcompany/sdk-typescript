...
[![NPM version](<https://img.shields.io/npm/v/@promptingcompany/sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@promptingcompany/sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@promptingcompany/sdk)
...
```sh
npm install git+ssh://git@github.com:promptingcompany/sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install @promptingcompany/sdk`
...
```ts
import ThePromptingCompany from 'npm:@promptingcompany/sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/promptingcompany/sdk-typescript/issues) with questions, bugs, or suggestions.
